...
export declare type UpdateMedia = UploadMedia;
...
export declare type CreateFilter = Pick<UpdateFilter, 'irreversible' | 'whole_word' | 'expires_in'>;
...
export declare type UpdatePushSubscription = Pick<AddPushSubscription, 'data'>;
